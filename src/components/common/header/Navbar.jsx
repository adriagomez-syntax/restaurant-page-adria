    ...
    return (
        <nav className="flex-1 flex flex-row justify-between items-center">
            ...
            <div className="md:flex-1 h-full flex">
                ...
                <div className="hidden flex min-h-screen min-w-screen top-0 left-0 -z-10 md:z-10 flex-1 md:flex bg-dark md:bg-none md:relative md:min-h-auto md:min-w-auto md:top-auto md:left-auto">
