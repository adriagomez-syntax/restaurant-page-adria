...
export default function FormReserveFinish({ className = "" }) {
	const persons = 2;
	...
	return (
		<div className={ className + " " + "flex flex-col gap-8 justify-center items-center" }>
			...
			<FilledButton className="bg-accent-2 text-background mt-2">Weitere Reservierung</FilledButton>
		</div>
	)
}